...
### reference https://www.kaggle.com/haqishen/ranzcr-1st-place-soluiton-cls-model-small-ver
...
def get_train_transforms(CFG):
    return A.Compose([   
            ##referemce from https://www.kaggle.com/haqishen/ranzcr-1st-place-soluiton-cls-model-small-ver

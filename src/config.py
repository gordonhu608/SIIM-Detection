...
#     criterion = 'LabelSmoothingBinaryCrossEntropy'  ### BinaryCrossEntropy, LabelSmoothingBinaryCrossEntropy
    ...
    save_row_num = 8
    save_dir = f'/data/output/siim-covid19-study-classification/{model_name}_folds_cutout_{image_size}_{epochs}e_{optimizer}_{scheduler}_{criterion}_ls{label_smoothing}_{seg_type}{seg_prob}_v2_dropdup/'